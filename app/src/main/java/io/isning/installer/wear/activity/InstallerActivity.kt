...
import io.isning.installer.wear.databinding.*
...
import io.isning.installer.wear.utils.*
import io.isning.installer.wear.view.CustomizeDialog
import io.isning.installer.wear.view.ProgressDrawable
import java.io.File
import java.util.*
...
class InstallerActivity : BaseActivity(), InstallCallback {
    ...
    override fun onInstallLog(installLog: String) {
        ...
        Log.d("InstallerActivity", installLog)
    }
